...
Collects user input.
Creates a DataFrame.
Arranges the features in the correct order.
Sends the input through the trained Machine Learning pipeline.
Generates the predicted paddy yield.
Displays the predicted yield in kilograms.
Example output:
